...
## 2026-05-27 â€” Founder note fix (090af0e)

**Modified:**
- `sin.html` â€” founder note updated to match pgwp.html and index.html (was missed in earlier pass)

---

## 2026-05-27 â€” Guide workflow connections (f373ebb)

**Modified:**
- `pgwp.html` â€” added "Next step" transition card linking to /sin.html before disclaimer
- `sin.html` â€” added "More guides coming" card before disclaimer
- `index.html` â€” added category labels (Study & Graduation / Working in Canada) above guide cards

---

## 2026-05-27 â€” Shared agent workflow
